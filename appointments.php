        ...
        <div class="profilewrapper">
            <div class="profile-left sidebarnav-width">
                <div class="profile-sidenav">
                    ...
                    <p><a href="#" class="active"><i class="mdi mdi-calendar-multiselect"></i>BOOK APPOINTMENTS</a></p>
                ...
                <div class="profilebody">
                    <div class="profilepage-pagination">
                        <div class="pageNumber">
                            <p><a href="#"><i class="mdi mdi-home"></i>Home</a> / <a href="./">Dashboard</a> / Appointments</p>
                        </div>
                    </div>
                    <div class="profilebody-body soon">
                        <h2> Previous appointments</h2>
                        <table>
                            <tr> 
                                <th>Patient Name </th>
                                <th> Date of appointment </th>
                                <th> Physician seen </th>
                                <th> Physician's comment </th>
                                </tr>
